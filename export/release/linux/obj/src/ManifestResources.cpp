...
HXLINE(  73)		{
HXLINE(  73)			::String v = (::ManifestResources_obj::rootPath + HX_("manifest/songs.json",38,27,75,ee));
HXDLIN(  73)			::lime::utils::Assets_obj::libraryPaths->set(HX_("songs",fe,36,c7,80),v);
            		}
HXLINE(  74)		{
HXLINE(  74)			::String v1 = (::ManifestResources_obj::rootPath + HX_("manifest/shared.json",f1,c2,0a,f4));
HXDLIN(  74)			::lime::utils::Assets_obj::libraryPaths->set(HX_("shared",a5,5e,2b,1d),v1);
            		}
HXLINE(  75)		{
HXLINE(  75)			::String v2 = (::ManifestResources_obj::rootPath + HX_("manifest/tutorial.json",58,c3,5d,36));
HXDLIN(  75)			::lime::utils::Assets_obj::libraryPaths->set(HX_("tutorial",9e,8f,b5,82),v2);
            		}
HXLINE(  76)		{
HXLINE(  76)			::String v3 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  76)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v3);
            		}
HXLINE(  60)		 ::lime::utils::AssetLibrary library = ::lime::utils::Assets_obj::getLibrary(HX_("songs",fe,36,c7,80));
HXLINE(  80)		if (::hx::IsNotNull( library )) {
HXLINE(  80)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  81)			::ManifestResources_obj::preloadLibraryNames->push(HX_("songs",fe,36,c7,80));
            		}
HXLINE(  82)		library = ::lime::utils::Assets_obj::getLibrary(HX_("shared",a5,5e,2b,1d));
HXLINE(  83)		if (::hx::IsNotNull( library )) {
HXLINE(  83)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  84)			::ManifestResources_obj::preloadLibraryNames->push(HX_("shared",a5,5e,2b,1d));
            		}
HXLINE(  85)		library = ::lime::utils::Assets_obj::getLibrary(HX_("tutorial",9e,8f,b5,82));
HXLINE(  86)		if (::hx::IsNotNull( library )) {
HXLINE(  86)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  87)			::ManifestResources_obj::preloadLibraryNames->push(HX_("tutorial",9e,8f,b5,82));
            		}
HXLINE(  88)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE(  89)		if (::hx::IsNotNull( library )) {
HXLINE(  89)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  90)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
