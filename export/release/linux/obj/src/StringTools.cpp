...
HX_LOCAL_STACK_FRAME(_hx_pos_0b3aba623971508c_297_ltrim,"StringTools","ltrim",0x24d2234a,"StringTools.ltrim","/usr/share/haxe/std/StringTools.hx",297,0xd8cfb08f)
HX_LOCAL_STACK_FRAME(_hx_pos_0b3aba623971508c_322_rtrim,"StringTools","rtrim",0x99399e50,"StringTools.rtrim","/usr/share/haxe/std/StringTools.hx",322,0xd8cfb08f)
HX_LOCAL_STACK_FRAME(_hx_pos_0b3aba623971508c_350_trim,"StringTools","trim",0x2908d066,"StringTools.trim","/usr/share/haxe/std/StringTools.hx",350,0xd8cfb08f)
HX_LOCAL_STACK_FRAME(_hx_pos_0b3aba623971508c_366_lpad,"StringTools","lpad",0x23bd8feb,"StringTools.lpad","/usr/share/haxe/std/StringTools.hx",366,0xd8cfb08f)
HX_LOCAL_STACK_FRAME(_hx_pos_0b3aba623971508c_425_replace,"StringTools","replace",0x6d651f30,"StringTools.replace","/usr/share/haxe/std/StringTools.hx",425,0xd8cfb08f)
HX_LOCAL_STACK_FRAME(_hx_pos_0b3aba623971508c_435_hex,"StringTools","hex",0xd91debd7,"StringTools.hex","/usr/share/haxe/std/StringTools.hx",435,0xd8cfb08f)
...
bool StringTools_obj::isSpace(::String s,int pos){
            	HX_STACKFRAME(&_hx_pos_0b3aba623971508c_279_isSpace)
...
::String StringTools_obj::ltrim(::String s){
            	HX_STACKFRAME(&_hx_pos_0b3aba623971508c_297_ltrim)
...
::String StringTools_obj::rtrim(::String s){
            	HX_STACKFRAME(&_hx_pos_0b3aba623971508c_322_rtrim)
...
::String StringTools_obj::trim(::String s){
            	HX_STACKFRAME(&_hx_pos_0b3aba623971508c_350_trim)
...
::String StringTools_obj::lpad(::String s,::String c,int l){
            	HX_GC_STACKFRAME(&_hx_pos_0b3aba623971508c_366_lpad)
...
::String StringTools_obj::replace(::String s,::String sub,::String by){
            	HX_STACKFRAME(&_hx_pos_0b3aba623971508c_425_replace)
...
::String StringTools_obj::hex(int n, ::Dynamic digits){
            	HX_STACKFRAME(&_hx_pos_0b3aba623971508c_435_hex)
