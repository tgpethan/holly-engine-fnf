...
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_46_init,"Main","init",0xea732345,"Main.init","Main.hx",46,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_56_setupGame,"Main","setupGame",0x7f7688ba,"Main.setupGame","Main.hx",56,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_82_setMaxFPS,"Main","setMaxFPS",0xfe7c4492,"Main.setMaxFPS","Main.hx",82,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_87_setFPSVisibility,"Main","setFPSVisibility",0xe69035ce,"Main.setFPSVisibility","Main.hx",87,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_26_main,"Main","main",0xed0e206e,"Main.main","Main.hx",26,0x087e5c05)

void Main_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_10_new)
HXLINE(  18)		this->startFullscreen = false;
HXLINE(  17)		this->skipSplash = true;
HXLINE(  16)		this->framerate = 120;
HXLINE(  15)		this->zoom = ((Float)-1);
HXLINE(  14)		this->initialState = ::hx::ClassOf< ::TitleState >();
HXLINE(  13)		this->gameHeight = 720;
HXLINE(  12)		this->gameWidth = 1280;
HXLINE(  31)		super::__construct();
HXLINE(  33)		this->fpsDisplay =  ::openfl::display::FPS_obj::__alloc( HX_CTX ,10,3,16777215);
HXLINE(  35)		if (::hx::IsNotNull( this->stage )) {
HXLINE(  37)			this->init(null());
            		}
            		else {
HXLINE(  41)			this->addEventListener(HX_("addedToStage",63,22,55,0c),this->init_dyn(),null(),null(),null());
            		}
            	}
...
void Main_obj::init( ::openfl::events::Event E){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_46_init)
HXLINE(  47)		if (this->hasEventListener(HX_("addedToStage",63,22,55,0c))) {
HXLINE(  49)			this->removeEventListener(HX_("addedToStage",63,22,55,0c),this->init_dyn(),null());
            		}
HXLINE(  52)		this->setupGame();
            	}
...
void Main_obj::setupGame(){
            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_56_setupGame)
...
HXLINE(  60)		if ((this->zoom == -1)) {
HXLINE(  62)			Float ratioX = (( (Float)(stageWidth) ) / ( (Float)(this->gameWidth) ));
HXLINE(  63)			Float ratioY = (( (Float)(stageHeight) ) / ( (Float)(this->gameHeight) ));
HXLINE(  64)			this->zoom = ::Math_obj::min(ratioX,ratioY);
HXLINE(  65)			this->gameWidth = ::Math_obj::ceil((( (Float)(stageWidth) ) / this->zoom));
HXLINE(  66)			this->gameHeight = ::Math_obj::ceil((( (Float)(stageHeight) ) / this->zoom));
            		}
HXLINE(  70)		this->initialState = ::hx::ClassOf< ::TitleState >();
...
HXLINE(  76)		this->addChild(this->fpsDisplay);
            	}


HX_DEFINE_DYNAMIC_FUNC0(Main_obj,setupGame,(void))

void Main_obj::setMaxFPS(int max){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_82_setMaxFPS)
HXDLIN(  82)		::openfl::Lib_obj::get_current()->stage->set_frameRate(( (Float)(max) ));
            	}


HX_DEFINE_DYNAMIC_FUNC1(Main_obj,setMaxFPS,(void))

void Main_obj::setFPSVisibility(bool visible){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_87_setFPSVisibility)
HXDLIN(  87)		this->fpsDisplay->set_visible(visible);
            	}


HX_DEFINE_DYNAMIC_FUNC1(Main_obj,setFPSVisibility,(void))

void Main_obj::main(){
            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_26_main)
HXDLIN(  26)		 ::openfl::display::MovieClip _hx_tmp = ::openfl::Lib_obj::get_current();
HXDLIN(  26)		_hx_tmp->addChild( ::Main_obj::__alloc( HX_CTX ));
            	}
...
void Main_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(fpsDisplay,"fpsDisplay");
...
void Main_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(fpsDisplay,"fpsDisplay");
...
::hx::Val Main_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"setMaxFPS") ) { return ::hx::Val( setMaxFPS_dyn() ); }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"gameHeight") ) { return ::hx::Val( gameHeight ); }
		if (HX_FIELD_EQ(inName,"skipSplash") ) { return ::hx::Val( skipSplash ); }
		if (HX_FIELD_EQ(inName,"fpsDisplay") ) { return ::hx::Val( fpsDisplay ); }
		break;
	case 12:
	...
	case 15:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"setFPSVisibility") ) { return ::hx::Val( setFPSVisibility_dyn() ); }
	}
...
::hx::Val Main_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"fpsDisplay") ) { fpsDisplay=inValue.Cast<  ::openfl::display::FPS >(); return inValue; }
		break;
	case 12:
...
void Main_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("fpsDisplay",59,49,8e,21));
...
static ::hx::StorageInfo Main_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::openfl::display::FPS */ ,(int)offsetof(Main_obj,fpsDisplay),HX_("fpsDisplay",59,49,8e,21)},
	{ ::hx::fsUnknown, 0, null()}
};
...
static ::String Main_obj_sMemberFields[] = {
	...
	HX_("setMaxFPS",e7,0c,f3,1d),
	HX_("setFPSVisibility",19,52,c2,a8),
	::String(null()) };
