...
HX_DEFINE_STACK_FRAME(_hx_pos_82fb9a78bb7ac900_484_new,"haxe._Unserializer.NullResolver","new",0x49a2304b,"haxe._Unserializer.NullResolver.new","/usr/share/haxe/std/haxe/Unserializer.hx",484,0x4786e765)
HX_LOCAL_STACK_FRAME(_hx_pos_82fb9a78bb7ac900_487_resolveClass,"haxe._Unserializer.NullResolver","resolveClass",0xc4a78861,"haxe._Unserializer.NullResolver.resolveClass","/usr/share/haxe/std/haxe/Unserializer.hx",487,0x4786e765)
HX_LOCAL_STACK_FRAME(_hx_pos_82fb9a78bb7ac900_490_resolveEnum,"haxe._Unserializer.NullResolver","resolveEnum",0x5f3252f8,"haxe._Unserializer.NullResolver.resolveEnum","/usr/share/haxe/std/haxe/Unserializer.hx",490,0x4786e765)
namespace haxe{
namespace _Unserializer{

void NullResolver_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_82fb9a78bb7ac900_484_new)
            	}
...
::hx::Class NullResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_82fb9a78bb7ac900_487_resolveClass)
...
::hx::Class NullResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_82fb9a78bb7ac900_490_resolveEnum)
