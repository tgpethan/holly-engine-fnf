...
HXLINE( 201)					{
HXLINE( 201)						 ::AlphaCharacter _g = letter;
...
HXLINE( 120)		 ::Alphabet _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXDLIN( 227)			this->set_y((a + ((((Float)0.16) * (( (Float)(60) ) / ( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("frameLimiter",bb,bb,7e,2f),::hx::paccDynamic)) ))) * (((scaledY * ( (Float)(120) )) + (( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.48))) - a))));
HXLINE( 228)			Float a1 = this->x;
HXDLIN( 228)			this->set_x((a1 + ((((Float)0.16) * (( (Float)(60) ) / ( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("frameLimiter",bb,bb,7e,2f),::hx::paccDynamic)) ))) * (((this->targetY * ( (Float)(20) )) + 90) - a1))));
            		}
