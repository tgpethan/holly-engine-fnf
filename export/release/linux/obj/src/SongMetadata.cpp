...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_276_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",276,0x0d86f62d)
...
HXLINE( 280)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 279)		this->week = 0;
HXLINE( 278)		this->songName = HX_("",00,00,00,00);
HXLINE( 284)		this->songName = song;
HXLINE( 285)		this->week = week;
HXLINE( 286)		this->songCharacter = songCharacter;
            	}
