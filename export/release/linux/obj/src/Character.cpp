...
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_526_update,"Character","update",0x0e18944e,"Character.update","Character.hx",526,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_562_dance,"Character","dance",0xde4da48e,"Character.dance","Character.hx",562,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_623_playAnim,"Character","playAnim",0xed2bd3aa,"Character.playAnim","Character.hx",623,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_654_addOffset,"Character","addOffset",0x6dc9376f,"Character.addOffset","Character.hx",654,0xf073a2d5)
...
HXDLIN( 270)			::String tex = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("BOYFRIEND",4a,99,10,e2)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 270)			 ::flixel::graphics::frames::FlxAtlasFrames tex1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("BOYFRIEND",4a,99,10,e2)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
...
HXDLIN( 127)			::String tex1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("DADDY_DEAREST",b1,a3,05,5d)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 127)			tex = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex1,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("DADDY_DEAREST",b1,a3,05,5d)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
...
HXDLIN( 474)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("christmas/mom_dad_christmas_assets",b9,c9,6d,11)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 474)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("christmas/mom_dad_christmas_assets",b9,c9,6d,11)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
...
HXLINE( 142)			goto _hx_goto_0;
            		...
            		_hx_goto_0:;
HXLINE( 500)		this->dance();
HXLINE( 502)		if (( (bool)(isPlayer) )) {
HXLINE( 504)			this->set_flipX(!(this->flipX));
HXLINE( 507)			if (!(::StringTools_obj::startsWith(this->curCharacter,HX_("bf",c4,55,00,00)))) {
HXLINE( 510)				::Array< int > oldRight = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHT",0d,6f,70,ac))) )->frames;
HXLINE( 511)				( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHT",0d,6f,70,ac))) )->frames = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFT",d6,39,ef,3b))) )->frames;
HXLINE( 512)				( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFT",d6,39,ef,3b))) )->frames = oldRight;
HXLINE( 515)				if (::hx::IsNotNull( this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3)) )) {
HXLINE( 517)					::Array< int > oldMiss = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3))) )->frames;
HXLINE( 518)					( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3))) )->frames = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFTmiss",d2,2f,9c,b6))) )->frames;
HXLINE( 519)					( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFTmiss",d2,2f,9c,b6))) )->frames = oldMiss;
            				}
            			}
            		}
            	}
...
void Character_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_526_update)
HXLINE( 527)		if (!(::StringTools_obj::startsWith(this->curCharacter,HX_("bf",c4,55,00,00)))) {
HXLINE( 529)			if (::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("sing",4f,96,53,4c))) {
HXLINE( 531)				 ::Character _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 531)				_hx_tmp->holdTimer = (_hx_tmp->holdTimer + elapsed);
            			}
HXLINE( 534)			Float dadVar = ( (Float)(4) );
HXLINE( 536)			if ((this->curCharacter == HX_("dad",47,36,4c,00))) {
HXLINE( 537)				dadVar = ((Float)6.1);
            			}
HXLINE( 538)			if ((this->holdTimer >= ((::Conductor_obj::stepCrochet * dadVar) * ((Float)0.001)))) {
HXLINE( 540)				this->dance();
HXLINE( 541)				this->holdTimer = ( (Float)(0) );
            			}
            		}
HXLINE( 545)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 548)			bool _hx_tmp;
HXDLIN( 548)			if ((this->animation->_curAnim->name == HX_("hairFall",bd,48,d6,cb))) {
HXLINE( 548)				_hx_tmp = this->animation->_curAnim->finished;
            			}
            			else {
HXLINE( 548)				_hx_tmp = false;
            			}
HXDLIN( 548)			if (_hx_tmp) {
HXLINE( 549)				this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            			}
            		}
HXLINE( 552)		this->super::update(elapsed);
            	}


void Character_obj::dance(){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_562_dance)
HXDLIN( 562)		if (!(this->debugMode)) {
HXLINE( 564)			::String _hx_switch_0 = this->curCharacter;
            			if (  (_hx_switch_0==HX_("gf",1f,5a,00,00)) ){
HXLINE( 567)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 569)					this->danced = !(this->danced);
HXLINE( 571)					if (this->danced) {
HXLINE( 572)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 574)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 567)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-car",a6,63,ab,07)) ){
HXLINE( 589)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 591)					this->danced = !(this->danced);
HXLINE( 593)					if (this->danced) {
HXLINE( 594)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 596)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 589)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-christmas",94,26,b1,6d)) ){
HXLINE( 578)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 580)					this->danced = !(this->danced);
HXLINE( 582)					if (this->danced) {
HXLINE( 583)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 585)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 578)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-pixel",98,3e,8c,55)) ){
HXLINE( 599)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 601)					this->danced = !(this->danced);
HXLINE( 603)					if (this->danced) {
HXLINE( 604)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 606)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 599)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("spooky",eb,bd,9e,c1)) ){
HXLINE( 610)				this->danced = !(this->danced);
HXLINE( 612)				if (this->danced) {
HXLINE( 613)					this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            				}
            				else {
HXLINE( 615)					this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            				}
HXLINE( 609)				goto _hx_goto_21;
            			}
            			/* default */{
HXLINE( 617)				this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
            			}
            			_hx_goto_21:;
            		}
            	}
...
void Character_obj::playAnim(::String AnimName,::hx::Null< bool >  __o_Force,::hx::Null< bool >  __o_Reversed,::hx::Null< int >  __o_Frame){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_623_playAnim)
HXLINE( 624)		this->animation->play(AnimName,Force,Reversed,Frame);
HXLINE( 626)		::cpp::VirtualArray daOffset = ( (::cpp::VirtualArray)(this->animOffsets->get(AnimName)) );
HXLINE( 627)		if (this->animOffsets->exists(AnimName)) {
HXLINE( 629)			this->offset->set(daOffset->__get(0),daOffset->__get(1));
            		}
            		else {
HXLINE( 632)			this->offset->set(0,0);
            		}
HXLINE( 634)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 636)			if ((AnimName == HX_("singLEFT",d6,39,ef,3b))) {
HXLINE( 638)				this->danced = true;
            			}
            			else {
HXLINE( 640)				if ((AnimName == HX_("singRIGHT",0d,6f,70,ac))) {
HXLINE( 642)					this->danced = false;
            				}
            			}
HXLINE( 645)			bool _hx_tmp;
HXDLIN( 645)			if ((AnimName != HX_("singUP",6a,52,21,b9))) {
HXLINE( 645)				_hx_tmp = (AnimName == HX_("singDOWN",31,2a,ad,36));
            			}
            			else {
HXLINE( 645)				_hx_tmp = true;
            			}
HXDLIN( 645)			if (_hx_tmp) {
HXLINE( 647)				this->danced = !(this->danced);
            			}
            		}
            	}
...
void Character_obj::addOffset(::String name,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_654_addOffset)
HXDLIN( 654)		::cpp::VirtualArray v = ::Array_obj< Float >::__new(2)->init(0,x)->init(1,y);
HXDLIN( 654)		this->animOffsets->set(name,v);
            	}
