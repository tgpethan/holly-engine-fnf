...
HX_DECLARE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_276_new)
...
{
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_276_new)
HXLINE( 280)		( ( ::SongMetadata)(__this) )->songCharacter = HX_("",00,00,00,00);
HXLINE( 279)		( ( ::SongMetadata)(__this) )->week = 0;
HXLINE( 278)		( ( ::SongMetadata)(__this) )->songName = HX_("",00,00,00,00);
HXLINE( 284)		( ( ::SongMetadata)(__this) )->songName = song;
HXLINE( 285)		( ( ::SongMetadata)(__this) )->week = week;
HXLINE( 286)		( ( ::SongMetadata)(__this) )->songCharacter = songCharacter;
            	}
